...
AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1003894643178 -1003749669792 -1002834808662") # add multiple channels here, separated by single space
AUTH_CHANNEL = [int(ch) for ch in AUTH_CHANNEL.strip().split()] if AUTH_CHANNEL else []
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1003749669792 -1003894643178') # add multiple channels here, separated by single space
