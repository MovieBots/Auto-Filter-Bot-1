...
AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1002765101816 -1002163955891") # add multiple channels here, separated by single space
AUTH_CHANNEL = [int(ch) for ch in AUTH_CHANNEL.strip().split()] if AUTH_CHANNEL else []
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1002765101816') # add multiple channels here, separated by single space
