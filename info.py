...
AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1003617072815 -1003533780140 -1002834808662") # add multiple channels here, separated by single space
AUTH_CHANNEL = [int(ch) for ch in AUTH_CHANNEL.strip().split()] if AUTH_CHANNEL else []
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1003617072815 -1003533780140') # add multiple channels here, separated by single space
