...
AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1002397558900 -1002995199569 -1002187860971") # add multiple channels here, separated by single space
AUTH_CHANNEL = [int(ch) for ch in AUTH_CHANNEL.strip().split()] if AUTH_CHANNEL else []
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1002397558900 -1002995199569') # add multiple channels here, separated by single space
