...
AUTH_CHANNEL = environ.get("AUTH_CHANNEL", "-1002502231251 -1002163955891") # add multiple channels here, separated by single space
AUTH_CHANNEL = [int(ch) for ch in AUTH_CHANNEL.strip().split()] if AUTH_CHANNEL else []
AUTH_REQ_CHANNEL = environ.get('AUTH_REQ_CHANNEL', '-1002502231251') # add multiple channels here, separated by single space
